package org.example.SpringSem4Hmwrk;
 ...
 * Используйте аннотацию @Controller и @RequestMapping для маршрутизации запросов
 * на эту страницу.
 ...
 * и выводит полученные данные. Это может быть форма для регистрации или любая другая форма,
 * которая собирает информацию от пользователя.
 */

@SpringBootApplication
public class SpringSem4HmwrkApplication {

	public static void main(String[] args) {
		SpringApplication.run(SpringSem4HmwrkApplication.class, args);
	}
